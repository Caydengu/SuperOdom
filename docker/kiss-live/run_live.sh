...
usage() {
  echo "Usage: run_live.sh --network-interface IFACE [--ros-domain-id ID] [--lowstate-port PORT] [--root-state-port PORT] [--container-name NAME]" >&2
}
